# Generated by Django 3.2.1 on 2021-05-07 18:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('district', models.CharField(choices=[('AL', 'Alappuzha'), ('ER', 'Ernakulam'), ('ID', 'Idukki'), ('KN', 'Kannur'), ('KS', 'Kasargod'), ('KL', 'Kollam'), ('KT', 'Kottayam'), ('KZ', 'Kozhikode'), ('MA', 'Malappuram'), ('PL', 'Palakkad'), ('PT', 'Pathanamthitta'), ('TV', 'Thiruvananthapuram'), ('TH', 'Thrissur'), ('WA', 'Wayanad')], max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('category', models.CharField(choices=[('C', 'Covid'), ('N', 'Normal'), ('I', 'ICU'), ('B', 'Ventilator')], max_length=2)),
